...
### Task3
run```python apps/m2/Task3.py HTMLfiles/huge_wikidatawiki.xml```
...
### Task4
run`python apps/m2/Task4.py HTMLfiles/huge_wikidatawiki.xml`
...
```
```commandline
python apps/m2/Task6.py [input path] [output path]
```
